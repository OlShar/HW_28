...
def test_page_right(selenium):
    """В правой части формы «Авторизация» находится продуктовый слоган ЛК "Ростелеком ID"."""
    try:
...
def test_elements_of_auth(selenium):
    """Блок аутентификации формы «Авторизация» содержит основные элементы (Меню выбора типа аутентификации,
...
def test_auth_by_invalid_email(selenium, incor_email, incor_passw):
    """Аутентификация пользователя с невалидным email и паролем:
